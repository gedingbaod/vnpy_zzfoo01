...
def main(csv_path):
    ...
    for file_path in file_list:
        ...
        for idx, row in instruments_df.iterrows():
            ...
            # current_time = datetime(2026, 1, 30)
            local_time = pd.Timestamp('2026-01-30', tz='Asia/Shanghai')
            ...
            if delisted_date > local_time:
                ...
                vnpy_tick_process(sec_id, exchange, local_time, local_time, Interval.TICK)
